...
Xvars = ['EU-CC', 'WTI-Oil', 'Brent-Oil', 'Zhengzhou-Coal', 'Dalian-Coal', 'Rtd-Coal', 'US-NatGas', 'SH-FOil', 'US-FOil', 'CSI300', 'US-DJI', 'USD-CNY']
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dcc.Dropdown(id="xvars_select", multi=True, options=Xvars, value=["Brent-Oil", 'Rtd-Coal', 'USD-CNY'], placeholder="Select Xvars", ),
